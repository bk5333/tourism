...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : PKR <?= $grand_total; ?>/- </span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Mobile No</span>
            <input type="tel" placeholder="03XX-XXXXXXX" maxlength="12" name="number" pattern="[0-9]{4}-[0-9]{7}" required>
         </div>
         <div class="inputBox">
            <span>Email</span>
         ...
         <div class="inputBox">
            ...
            <input type="email" placeholder="Cash on Delivery" name="method" readonly style="border: 0px;">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="Postal/Zip Code" maxlength="7" name="pin_code" required>
         </div>
      </div>
