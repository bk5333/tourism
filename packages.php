...
<section class="page-section" id="home" style="background-image: url(''); background-size: cover; backdrop-filter: blur(3px);">
	
	<div class="container">
		<h2 class="text-center" style="color: ;">Tour Packages</h2>
...
?>
				...
				<div class="w-100 d-flex justify-content-between">
					<span class="rounded-3 btn bg-gray btn-secondary btn-flat btn-sm"><i class="fa fa-tag"></i> <?php echo number_format($row['cost']) ?></span>
					<?php if ($status == 0): ?>
