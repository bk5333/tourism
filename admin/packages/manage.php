...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="package-form">
            ...
            <div class="form-group">
				<label for="cost" class="control-label">Seats</label>
                <input type="number" step="any" class="form form-control" name="seats" value="<?php echo isset($seats) ? $seats : 0; ?>">
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="http://localhost/tourism/admin/?page=packages">Cancel</a>
	</div>
</div>
<script>
