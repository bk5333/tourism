                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=books" class="nav-link nav-books">
                        ...
                        <p>
                          Bookings &nbsp;&nbsp;&nbsp;
                          <?php
// Assuming you are using a database connection named $conn
$query = "SELECT COUNT(*) AS notification_count FROM book_list WHERE status = 0";
...
if ($result) {
    ...
    if ($notificationCount > 0) {
        echo '<span class="notification" style="color: black">' . $notificationCount . '</span>';
    }
}
?>
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=inquiries" class="nav-link nav-inquiries">
                        ...
                        <?php
// Assuming you are using a database connection named $conn
$query = "SELECT COUNT(*) AS notification_count FROM inquiry WHERE status = 0";
$result = mysqli_query($conn, $query);
...
?>
                    ...
                    <li class="nav-item dropdown">
                      <a href="http://localhost/tourism/admin.php" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>odfs/admin/?page=home" class="nav-link">
