...
<head>
   ...
   <title>Tour Hub-Admin Panel</title>
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <a href="http://localhost/tourism/admin/" style="color: white;"><button class="btn btn-sm btn-primary">Back</a></button></a>
</form>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="admin.php"><input type="reset" value="cancel" id="close-edit" class="option-btn"></a>
   </form>
